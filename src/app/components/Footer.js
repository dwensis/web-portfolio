...
export default function Footer() {
    ...
    return (
        <footer className="footer w-full my-10">
            <div className="container flex border-t border-gray-600 py-12">
                <div className="w-6/12 flex align-start">
                    <a href="/" className="header--logo h-fit">
                ...
                <div className="w-6/12">
                    <div className="footer-nav flex justify-end gap-8">
                    ...
                    <div className="socials flex justify-end gap-8 mt-20">
                        <a href="">
